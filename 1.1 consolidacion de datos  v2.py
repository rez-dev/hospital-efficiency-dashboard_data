...
consolidated_total = pd.read_excel('./Consolidado estadísticas hospitalarias.xlsx', sheet_name='2023',skiprows=1)
...
quirofanos_2023 = pd.read_csv('./2023/variables/2023_quirofanos.txt', header=None).transpose()
quirofanos_2023.columns = quirofanos_2023.iloc[0]
quirofanos = quirofanos_2023.columns
...
df_2023.to_csv('./df_2023_V2.csv', index=False, encoding='utf-8')
